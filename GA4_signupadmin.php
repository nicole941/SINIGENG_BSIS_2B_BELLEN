...
<body>
  ...
  <nav class="navbar navbar-expand-lg">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <!-- Icons -->
      <div class="icons">
        <a href="login form.php" class="fas fa-user me-3"></a>
      </div>
    </div>
  </nav>
  ...
  <div class="login-container container my-5">
    ...
    <form action="adminsignupprocess.php" method="POST">
    ...
    <p class="text-center mt-3">
      Already a seller? <a href="loginadmin.php" class="register-link">Login</a>
    </p>
  </div>
</body>
